...
import AdminOrderStatusSheet, { getOrderStatusOption } from '../../../components/admin/orders/AdminOrderStatusSheet'
    ...
    return (
      <div dir="rtl" className="mx-auto flex min-h-screen max-w-sm flex-col bg-bg-main">
        <div className="flex-1 px-4 pt-4">
          <AdminScreenHeader icon={checkbookIcon} iconClassName="icon-strong" title="لیست سفارشات" onBack={onBack} />

...
const topItems = [
  ...
  {
    key: 'referral',
    title: 'معرفی منوچ به دیگران',
    supportingText: '۱۰/۰',
    icon: referralIcon,
  },
  {
    key: 'domain',
    title: 'تنظیم دامنه اختصاصی',
    icon: domainIcon,
  },
  {
    key: 'payment',
    title: 'تنظیمات اینماد و درگاه پرداخت',
    icon: paymentIcon,
  },
]
...
const marketingItems = [
  {
    ...
    description: 'به مشتریان خودتان',
    icon: mailIcon,
  },
  {
    key: 'platform-ads',
    title: 'تبلیغ در پلتفرم',
    description: 'تبلیغات در دسته های متفاوت',
    icon: micIcon,
  },
]
...
const socialLinks = [
  {
    key: 'instagram',
    label: 'instagram',
    icon: <img src={instagramIcon} alt="" className="h-6 w-6 icon-moderate" />,
  },
  {
    key: 'telegram',
    label: 'telegram',
    icon: <img src={telegramIcon} alt="" className="h-6 w-6" />,
  },
  {
    key: 'youtube',
    label: 'youtube',
    icon: <img src={youtubeIcon} alt="" className="h-6 w-6" />,
  },
]
        ...
        >
          ...
          <section className="mt-3">
            ...
            <div className="mt-2 space-y-1">
              ...
              <ActionLink
                icon={<img src={instagramIcon} alt="" className="h-6 w-6" />}
              >
                اینستاگرام منوچ
              </ActionLink>
            </div>

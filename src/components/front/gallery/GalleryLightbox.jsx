...
const GalleryLightbox = ({ item, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image + caption */}
      <div
        className="flex-1 mx-4 relative rounded-lg overflow-hidden min-h-0 bg-header-to"
        onClick={e => e.stopPropagation()}
      >
        <img src={item.image} alt={item.title} className="absolute inset-0 size-full object-contain rounded-lg" />
